...
{
    public abstract class MfWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MfWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MfWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MfDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MfDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MfDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MfDbContext, Task<T>> func)
        {
            T result;
